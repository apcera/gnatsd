...
// Used to call back into the upper layers to report on newly created tombstones.
type TombstoneUpdateHandler func(seq uint64, subj string)
...
type StreamStore interface {
	...
	RegisterTombstoneUpdates(TombstoneUpdateHandler)
